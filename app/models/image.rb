class Image < ActiveRecord::Base
  ...
  has_attached_file :image, :styles => { :icon => "32x16>", :thumb => "48x36#", :small => "85x55#", :medium => "200x9999>", :large => "880x9999>", :slide => "472x365>", :sponsor => "120x65>" }
  has_attached_file :featured_image, :styles => { :thumb => "48x36#", :small => "85x55#", :medium => "200x142#", :slide => "472x9999>" }
